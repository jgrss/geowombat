...
class Converters(object):
    ...
    def polygon_to_array(self,
        ...
        Args:
            ...
            fill (Optional[int|float]): Used as fill value for all areas not covered by input geometries to ``rasterio.features.rasterize``.
            default_value (Optional[int|float]): Used as value for all geometries, if not provided in shapes to ``rasterio.features.rasterize``.
