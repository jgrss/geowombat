...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "geowombat.moving._moving",
        "sources": [
            "geowombat/moving/_moving.pyx"
        ]
    },
    "module_name": "geowombat.moving._moving"
}
END: Cython Metadata */
...
#define __PYX_HAVE__geowombat__moving___moving
#define __PYX_HAVE_API__geowombat__moving___moving
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* "geowombat/moving/_moving.pyx":17
 * 
 ...
 * 
 */
typedef __pyx_t_5numpy_float64_t __pyx_t_9geowombat_6moving_7_moving_DTYPE_float64_t;
/* Declarations.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* "geowombat/moving/_moving.pyx":25
 * 
 ...
 * 
 */
typedef double (*__pyx_t_9geowombat_6moving_7_moving_metric_ptr)(__Pyx_memviewslice, Py_ssize_t, Py_ssize_t, Py_ssize_t, unsigned int, unsigned int, double);
...
/* Module declarations from 'geowombat.moving._moving' */
...
static double __pyx_f_9geowombat_6moving_7_moving__get_var(__Pyx_memviewslice, Py_ssize_t, Py_ssize_t, Py_ssize_t, unsigned int, unsigned int, double); /*proto*/
static double __pyx_f_9geowombat_6moving_7_moving__get_std(__Pyx_memviewslice, Py_ssize_t, Py_ssize_t, Py_ssize_t, unsigned int, unsigned int, double); /*proto*/
static double __pyx_f_9geowombat_6moving_7_moving__get_mean(__Pyx_memviewslice, Py_ssize_t, Py_ssize_t, Py_ssize_t, unsigned int, unsigned int, double); /*proto*/
static double __pyx_f_9geowombat_6moving_7_moving__get_min(__Pyx_memviewslice, Py_ssize_t, Py_ssize_t, Py_ssize_t, unsigned int, unsigned int, double); /*proto*/
static double __pyx_f_9geowombat_6moving_7_moving__get_max(__Pyx_memviewslice, Py_ssize_t, Py_ssize_t, Py_ssize_t, unsigned int, unsigned int, double); /*proto*/
static PyObject *__pyx_f_9geowombat_6moving_7_moving__moving_window3d(__Pyx_memviewslice, PyObject *, unsigned int, unsigned int); /*proto*/
...
#define __Pyx_MODULE_NAME "geowombat.moving._moving"
extern int __pyx_module_is_main_geowombat__moving___moving;
int __pyx_module_is_main_geowombat__moving___moving = 0;

/* Implementation of 'geowombat.moving._moving' */
...
static const char __pyx_k_geowombat_moving__moving[] = "geowombat.moving._moving";
static const char __pyx_k_Invalid_shape_in_axis_d_d[] = "Invalid shape in axis %d: %d.";
static const char __pyx_k_itemsize_0_for_cython_array[] = "itemsize <= 0 for cython.array";
static const char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static const char __pyx_k_geowombat_moving__moving_pyx[] = "geowombat/moving/_moving.pyx";
...
static PyObject *__pyx_n_s_geowombat_moving__moving;
static PyObject *__pyx_kp_s_geowombat_moving__moving_pyx;
...
static PyObject *__pyx_pf_9geowombat_6moving_7_moving_moving_window(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_input, PyObject *__pyx_v_stat, PyObject *__pyx_v_w, PyObject *__pyx_v_n_jobs); /* proto */
...
/* "geowombat/moving/_moving.pyx":28
 * 
 * 
...
static double __pyx_f_9geowombat_6moving_7_moving__get_var(__Pyx_memviewslice __pyx_v_input_view, Py_ssize_t __pyx_v_z, Py_ssize_t __pyx_v_i, Py_ssize_t __pyx_v_j, CYTHON_UNUSED unsigned int __pyx_v_dims, unsigned int __pyx_v_w, double __pyx_v_w_samples) {
  Py_ssize_t __pyx_v_m;
  Py_ssize_t __pyx_v_n;
  double __pyx_v_window_mean;
  double __pyx_v_window_var;
  double __pyx_r;
  ...
  /* "geowombat/moving/_moving.pyx":38
 *     cdef:
 *         Py_ssize_t m, n
 ...
 * 
 */
  __pyx_v_window_mean = 0.0;

  /* "geowombat/moving/_moving.pyx":39
 *         Py_ssize_t m, n
 *         double window_mean = 0.0
 *         double window_var = 0.0             # <<<<<<<<<<<<<<
 * 
 *     # Mean
 */
  __pyx_v_window_var = 0.0;

  /* "geowombat/moving/_moving.pyx":42
 * 
 *     # Mean
 *     for m in range(0, w):             # <<<<<<<<<<<<<<
 *         for n in range(0, w):
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "geowombat/moving/_moving.pyx":43
 *     # Mean
 *     for m in range(0, w):
 *         for n in range(0, w):             # <<<<<<<<<<<<<<
 *             window_mean += input_view[z, i+m, j+n]
 ...
 */
    ...
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      ...
      /* "geowombat/moving/_moving.pyx":44
 *     for m in range(0, w):
 *         for n in range(0, w):
 *             window_mean += input_view[z, i+m, j+n]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_7 = __pyx_v_z;
      __pyx_t_8 = (__pyx_v_i + __pyx_v_m);
      __pyx_t_9 = (__pyx_v_j + __pyx_v_n);
      __pyx_v_window_mean = (__pyx_v_window_mean + (*((double *) ( /* dim=2 */ ((char *) (((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_input_view.data + __pyx_t_7 * __pyx_v_input_view.strides[0]) ) + __pyx_t_8 * __pyx_v_input_view.strides[1]) )) + __pyx_t_9)) ))));
    }
  }

  /* "geowombat/moving/_moving.pyx":46
 *             window_mean += input_view[z, i+m, j+n]
 * 
 *     window_mean /= w_samples             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_window_mean = (__pyx_v_window_mean / __pyx_v_w_samples);

  /* "geowombat/moving/_moving.pyx":49
 * 
 *     # Deviation from the mean
 *     for m in range(0, w):             # <<<<<<<<<<<<<<
 *         for n in range(0, w):
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "geowombat/moving/_moving.pyx":50
 *     # Deviation from the mean
 *     for m in range(0, w):
 *         for n in range(0, w):             # <<<<<<<<<<<<<<
 *             window_var += (input_view[z, i+m, j+n] - window_mean)**2
 ...
 */
    ...
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      ...
      /* "geowombat/moving/_moving.pyx":51
 *     for m in range(0, w):
 *         for n in range(0, w):
 *             window_var += (input_view[z, i+m, j+n] - window_mean)**2             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_t_11 = (__pyx_v_i + __pyx_v_m);
      __pyx_t_12 = (__pyx_v_j + __pyx_v_n);
      __pyx_v_window_var = (__pyx_v_window_var + pow(((*((double *) ( /* dim=2 */ ((char *) (((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_input_view.data + __pyx_t_10 * __pyx_v_input_view.strides[0]) ) + __pyx_t_11 * __pyx_v_input_view.strides[1]) )) + __pyx_t_12)) ))) - __pyx_v_window_mean), 2.0));
    }
  }

  /* "geowombat/moving/_moving.pyx":53
 *             window_var += (input_view[z, i+m, j+n] - window_mean)**2
 * 
 *     return window_var / w_samples             # <<<<<<<<<<<<<<
 * 
 * 
 */
  __pyx_r = (__pyx_v_window_var / __pyx_v_w_samples);
  goto __pyx_L0;
...
/* "geowombat/moving/_moving.pyx":56
 * 
 * 
...
static double __pyx_f_9geowombat_6moving_7_moving__get_std(__Pyx_memviewslice __pyx_v_input_view, Py_ssize_t __pyx_v_z, Py_ssize_t __pyx_v_i, Py_ssize_t __pyx_v_j, CYTHON_UNUSED unsigned int __pyx_v_dims, unsigned int __pyx_v_w, double __pyx_v_w_samples) {
  Py_ssize_t __pyx_v_m;
  Py_ssize_t __pyx_v_n;
  double __pyx_v_window_mean;
  double __pyx_v_window_var;
  ...
  /* "geowombat/moving/_moving.pyx":66
 *     cdef:
 *         Py_ssize_t m, n
 *         double window_mean = 0.0             # <<<<<<<<<<<<<<
 *         double window_var = 0.0
 ...
 */
  ...
  /* "geowombat/moving/_moving.pyx":67
 *         Py_ssize_t m, n
 *         double window_mean = 0.0
 *         double window_var = 0.0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "geowombat/moving/_moving.pyx":70
 * 
 *     # Mean
 *     for m in range(0, w):             # <<<<<<<<<<<<<<
 *         for n in range(0, w):
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "geowombat/moving/_moving.pyx":71
 *     # Mean
 *     for m in range(0, w):
 *         for n in range(0, w):             # <<<<<<<<<<<<<<
 *             window_mean += input_view[z, i+m, j+n]
 ...
 */
    ...
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      ...
      /* "geowombat/moving/_moving.pyx":72
 *     for m in range(0, w):
 *         for n in range(0, w):
 *             window_mean += input_view[z, i+m, j+n]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "geowombat/moving/_moving.pyx":74
 *             window_mean += input_view[z, i+m, j+n]
 * 
 *     window_mean /= w_samples             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "geowombat/moving/_moving.pyx":77
 * 
 *     # Deviation from the mean
 *     for m in range(0, w):             # <<<<<<<<<<<<<<
 *         for n in range(0, w):
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "geowombat/moving/_moving.pyx":78
 *     # Deviation from the mean
 *     for m in range(0, w):
 *         for n in range(0, w):             # <<<<<<<<<<<<<<
 *             window_var += (input_view[z, i+m, j+n] - window_mean)**2
 ...
 */
    ...
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      ...
      /* "geowombat/moving/_moving.pyx":79
 *     for m in range(0, w):
 *         for n in range(0, w):
 *             window_var += (input_view[z, i+m, j+n] - window_mean)**2             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "geowombat/moving/_moving.pyx":81
 *             window_var += (input_view[z, i+m, j+n] - window_mean)**2
 * 
 *     window_var /= w_samples             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_window_var = (__pyx_v_window_var / __pyx_v_w_samples);

  /* "geowombat/moving/_moving.pyx":83
 *     window_var /= w_samples
 * 
 *     return sqrt(window_var)             # <<<<<<<<<<<<<<
 * 
 * 
 */
  __pyx_r = sqrt(__pyx_v_window_var);
  goto __pyx_L0;
...
/* "geowombat/moving/_moving.pyx":86
 * 
 * 
...
static double __pyx_f_9geowombat_6moving_7_moving__get_mean(__Pyx_memviewslice __pyx_v_input_view, Py_ssize_t __pyx_v_z, Py_ssize_t __pyx_v_i, Py_ssize_t __pyx_v_j, CYTHON_UNUSED unsigned int __pyx_v_dims, unsigned int __pyx_v_w, double __pyx_v_w_samples) {
  Py_ssize_t __pyx_v_m;
  Py_ssize_t __pyx_v_n;
  double __pyx_v_window_mean;
  double __pyx_r;
  ...
  /* "geowombat/moving/_moving.pyx":96
 *     cdef:
 *         Py_ssize_t m, n
 *         double window_mean = 0.0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "geowombat/moving/_moving.pyx":98
 *         double window_mean = 0.0
 * 
 *     for m in range(0, w):             # <<<<<<<<<<<<<<
 *         for n in range(0, w):
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "geowombat/moving/_moving.pyx":99
 * 
 *     for m in range(0, w):
 *         for n in range(0, w):             # <<<<<<<<<<<<<<
 *             window_mean += input_view[z, i+m, j+n]
 ...
 */
    ...
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      ...
      /* "geowombat/moving/_moving.pyx":100
 *     for m in range(0, w):
 *         for n in range(0, w):
 *             window_mean += input_view[z, i+m, j+n]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "geowombat/moving/_moving.pyx":102
 *             window_mean += input_view[z, i+m, j+n]
 * 
 *     return window_mean / w_samples             # <<<<<<<<<<<<<<
 * 
 * 
 */
  __pyx_r = (__pyx_v_window_mean / __pyx_v_w_samples);
  goto __pyx_L0;
...
/* "geowombat/moving/_moving.pyx":105
 * 
 * 
...
static double __pyx_f_9geowombat_6moving_7_moving__get_min(__Pyx_memviewslice __pyx_v_input_view, Py_ssize_t __pyx_v_z, Py_ssize_t __pyx_v_i, Py_ssize_t __pyx_v_j, CYTHON_UNUSED unsigned int __pyx_v_dims, unsigned int __pyx_v_w, CYTHON_UNUSED double __pyx_v_w_samples) {
  Py_ssize_t __pyx_v_m;
  Py_ssize_t __pyx_v_n;
  double __pyx_v_window_min;
  double __pyx_r;
  unsigned int __pyx_t_1;
  unsigned int __pyx_t_2;
  Py_ssize_t __pyx_t_3;
  ...
  /* "geowombat/moving/_moving.pyx":115
 *     cdef:
 *         Py_ssize_t m, n
 ...
 *     for m in range(0, w):
 */
  __pyx_v_window_min = 1e9;

  /* "geowombat/moving/_moving.pyx":117
 *         double window_min = 1e9
 * 
 *     for m in range(0, w):             # <<<<<<<<<<<<<<
 *         for n in range(0, w):
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "geowombat/moving/_moving.pyx":118
 * 
 *     for m in range(0, w):
 *         for n in range(0, w):             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      ...
      /* "geowombat/moving/_moving.pyx":120
 *         for n in range(0, w):
 * 
 *             if input_view[z, i+m, j+n] < window_min:             # <<<<<<<<<<<<<<
 ...
 */
      ...
      __pyx_t_8 = (__pyx_v_i + __pyx_v_m);
      __pyx_t_9 = (__pyx_v_j + __pyx_v_n);
      __pyx_t_10 = (((*((double *) ( /* dim=2 */ ((char *) (((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_input_view.data + __pyx_t_7 * __pyx_v_input_view.strides[0]) ) + __pyx_t_8 * __pyx_v_input_view.strides[1]) )) + __pyx_t_9)) ))) < __pyx_v_window_min) != 0);
      if (__pyx_t_10) {

        /* "geowombat/moving/_moving.pyx":121
 * 
 *             if input_view[z, i+m, j+n] < window_min:
 *                 window_min = input_view[z, i+m, j+n]             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        __pyx_t_12 = (__pyx_v_i + __pyx_v_m);
        __pyx_t_13 = (__pyx_v_j + __pyx_v_n);
        __pyx_v_window_min = (*((double *) ( /* dim=2 */ ((char *) (((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_input_view.data + __pyx_t_11 * __pyx_v_input_view.strides[0]) ) + __pyx_t_12 * __pyx_v_input_view.strides[1]) )) + __pyx_t_13)) )));
 ...
 */
  ...
  /* "geowombat/moving/_moving.pyx":123
 *                 window_min = input_view[z, i+m, j+n]
 * 
 *     return window_min             # <<<<<<<<<<<<<<
 * 
...
/* "geowombat/moving/_moving.pyx":126
 * 
 * 
...
static double __pyx_f_9geowombat_6moving_7_moving__get_max(__Pyx_memviewslice __pyx_v_input_view, Py_ssize_t __pyx_v_z, Py_ssize_t __pyx_v_i, Py_ssize_t __pyx_v_j, CYTHON_UNUSED unsigned int __pyx_v_dims, unsigned int __pyx_v_w, CYTHON_UNUSED double __pyx_v_w_samples) {
  Py_ssize_t __pyx_v_m;
  Py_ssize_t __pyx_v_n;
  double __pyx_v_window_max;
  double __pyx_r;
  unsigned int __pyx_t_1;
  unsigned int __pyx_t_2;
  Py_ssize_t __pyx_t_3;
  ...
  /* "geowombat/moving/_moving.pyx":136
 *     cdef:
 *         Py_ssize_t m, n
 ...
 *     for m in range(0, w):
 */
  __pyx_v_window_max = -1e9;

  /* "geowombat/moving/_moving.pyx":138
 *         double window_max = -1e9
 * 
 *     for m in range(0, w):             # <<<<<<<<<<<<<<
 *         for n in range(0, w):
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "geowombat/moving/_moving.pyx":139
 * 
 *     for m in range(0, w):
 *         for n in range(0, w):             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      ...
      /* "geowombat/moving/_moving.pyx":141
 *         for n in range(0, w):
 * 
 *             if input_view[z, i+m, j+n] > window_max:             # <<<<<<<<<<<<<<
 ...
 */
      ...
      __pyx_t_8 = (__pyx_v_i + __pyx_v_m);
      __pyx_t_9 = (__pyx_v_j + __pyx_v_n);
      __pyx_t_10 = (((*((double *) ( /* dim=2 */ ((char *) (((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_input_view.data + __pyx_t_7 * __pyx_v_input_view.strides[0]) ) + __pyx_t_8 * __pyx_v_input_view.strides[1]) )) + __pyx_t_9)) ))) > __pyx_v_window_max) != 0);
      if (__pyx_t_10) {

        /* "geowombat/moving/_moving.pyx":142
 * 
 *             if input_view[z, i+m, j+n] > window_max:
 *                 window_max = input_view[z, i+m, j+n]             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        __pyx_t_12 = (__pyx_v_i + __pyx_v_m);
        __pyx_t_13 = (__pyx_v_j + __pyx_v_n);
        __pyx_v_window_max = (*((double *) ( /* dim=2 */ ((char *) (((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_input_view.data + __pyx_t_11 * __pyx_v_input_view.strides[0]) ) + __pyx_t_12 * __pyx_v_input_view.strides[1]) )) + __pyx_t_13)) )));
 ...
 */
  ...
  /* "geowombat/moving/_moving.pyx":144
 *                 window_max = input_view[z, i+m, j+n]
 * 
 *     return window_max             # <<<<<<<<<<<<<<
 * 
...
/* "geowombat/moving/_moving.pyx":147
 * 
 * 
...
static PyObject *__pyx_f_9geowombat_6moving_7_moving__moving_window3d(__Pyx_memviewslice __pyx_v_input, PyObject *__pyx_v_stat, unsigned int __pyx_v_window_size, unsigned int __pyx_v_n_jobs) {
  ...
  double __pyx_v_w_samples;
  unsigned int __pyx_v_hw;
  unsigned int __pyx_v_row_dims;
  unsigned int __pyx_v_col_dims;
  __Pyx_memviewslice __pyx_v_output = { 0, 0, { 0 }, { 0 }, { 0 } };
  __pyx_t_9geowombat_6moving_7_moving_metric_ptr __pyx_v_window_function;
  ...
  __Pyx_RefNannySetupContext("_moving_window3d", 0);

  /* "geowombat/moving/_moving.pyx":154
 *     cdef:
 *         Py_ssize_t z, i, j
 ...
 */
  __pyx_v_dims = (__pyx_v_input.shape[0]);

  /* "geowombat/moving/_moving.pyx":155
 *         Py_ssize_t z, i, j
 *         unsigned int dims = input.shape[0]
 *         unsigned int rows = input.shape[1]             # <<<<<<<<<<<<<<
 *         unsigned int cols = input.shape[2]
 ...
 */
  __pyx_v_rows = (__pyx_v_input.shape[1]);

  /* "geowombat/moving/_moving.pyx":156
 *         unsigned int dims = input.shape[0]
 *         unsigned int rows = input.shape[1]
 *         unsigned int cols = input.shape[2]             # <<<<<<<<<<<<<<
 *         double w_samples = window_size * 2.0
 ...
 */
  __pyx_v_cols = (__pyx_v_input.shape[2]);

  /* "geowombat/moving/_moving.pyx":157
 *         unsigned int rows = input.shape[1]
 *         unsigned int cols = input.shape[2]
 *         double w_samples = window_size * 2.0             # <<<<<<<<<<<<<<
 *         unsigned int hw = <int>(window_size / 2.0)
 ...
 */
  __pyx_v_w_samples = (__pyx_v_window_size * 2.0);

  /* "geowombat/moving/_moving.pyx":158
 *         unsigned int cols = input.shape[2]
 *         double w_samples = window_size * 2.0
 *         unsigned int hw = <int>(window_size / 2.0)             # <<<<<<<<<<<<<<
 *         unsigned int row_dims = rows - <int>(hw*2.0)
 ...
 */
  __pyx_v_hw = ((int)(__pyx_v_window_size / 2.0));

  /* "geowombat/moving/_moving.pyx":159
 *         double w_samples = window_size * 2.0
 *         unsigned int hw = <int>(window_size / 2.0)
 *         unsigned int row_dims = rows - <int>(hw*2.0)             # <<<<<<<<<<<<<<
 *         unsigned int col_dims = cols - <int>(hw*2.0)
 ...
 */
  __pyx_v_row_dims = (__pyx_v_rows - ((int)(__pyx_v_hw * 2.0)));

  /* "geowombat/moving/_moving.pyx":160
 *         unsigned int hw = <int>(window_size / 2.0)
 *         unsigned int row_dims = rows - <int>(hw*2.0)
 *         unsigned int col_dims = cols - <int>(hw*2.0)             # <<<<<<<<<<<<<<
 *         double[:, :, ::1] output = np.zeros((dims, rows, cols), dtype='float64')
 ...
 */
  __pyx_v_col_dims = (__pyx_v_cols - ((int)(__pyx_v_hw * 2.0)));

  /* "geowombat/moving/_moving.pyx":161
 *         unsigned int row_dims = rows - <int>(hw*2.0)
 *         unsigned int col_dims = cols - <int>(hw*2.0)
 *         double[:, :, ::1] output = np.zeros((dims, rows, cols), dtype='float64')             # <<<<<<<<<<<<<<
 *         metric_ptr window_function
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_From_unsigned_int(__pyx_v_dims); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 161, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyInt_From_unsigned_int(__pyx_v_rows); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 161, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyInt_From_unsigned_int(__pyx_v_cols); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 161, __pyx_L1_error)
  ...
  __Pyx_GOTREF(__pyx_t_5);
  if (PyDict_SetItem(__pyx_t_5, __pyx_n_s_dtype, __pyx_n_s_float64) < 0) __PYX_ERR(0, 161, __pyx_L1_error)
  __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_4, __pyx_t_5); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 161, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_d_d_dc_double(__pyx_t_3, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 161, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_output = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "geowombat/moving/_moving.pyx":164
 *         metric_ptr window_function
 * 
 *     if stat == 'mean':             # <<<<<<<<<<<<<<
 ...
 *     elif stat == 'std':
 */
  __pyx_t_7 = (__Pyx_PyString_Equals(__pyx_v_stat, __pyx_n_s_mean, Py_EQ)); if (unlikely(__pyx_t_7 < 0)) __PYX_ERR(0, 164, __pyx_L1_error)
  __pyx_t_8 = (__pyx_t_7 != 0);
  if (__pyx_t_8) {

    /* "geowombat/moving/_moving.pyx":165
 * 
 *     if stat == 'mean':
 *         window_function = &_get_mean             # <<<<<<<<<<<<<<
 *     elif stat == 'std':
 ...
 */
    __pyx_v_window_function = (&__pyx_f_9geowombat_6moving_7_moving__get_mean);
 ...
 */
  ...
  /* "geowombat/moving/_moving.pyx":166
 *     if stat == 'mean':
 *         window_function = &_get_mean
 *     elif stat == 'std':             # <<<<<<<<<<<<<<
 *         window_function = &_get_std
 *     elif stat == 'var':
 */
  __pyx_t_8 = (__Pyx_PyString_Equals(__pyx_v_stat, __pyx_n_s_std, Py_EQ)); if (unlikely(__pyx_t_8 < 0)) __PYX_ERR(0, 166, __pyx_L1_error)
  __pyx_t_7 = (__pyx_t_8 != 0);
  if (__pyx_t_7) {

    /* "geowombat/moving/_moving.pyx":167
 *         window_function = &_get_mean
 *     elif stat == 'std':
 *         window_function = &_get_std             # <<<<<<<<<<<<<<
 *     elif stat == 'var':
 ...
 */
    __pyx_v_window_function = (&__pyx_f_9geowombat_6moving_7_moving__get_std);
 ...
 */
  ...
  /* "geowombat/moving/_moving.pyx":168
 *     elif stat == 'std':
 *         window_function = &_get_std
 *     elif stat == 'var':             # <<<<<<<<<<<<<<
 *         window_function = &_get_var
 *     elif stat == 'min':
 */
  __pyx_t_7 = (__Pyx_PyString_Equals(__pyx_v_stat, __pyx_n_s_var, Py_EQ)); if (unlikely(__pyx_t_7 < 0)) __PYX_ERR(0, 168, __pyx_L1_error)
  __pyx_t_8 = (__pyx_t_7 != 0);
  if (__pyx_t_8) {

    /* "geowombat/moving/_moving.pyx":169
 *         window_function = &_get_std
 *     elif stat == 'var':
 *         window_function = &_get_var             # <<<<<<<<<<<<<<
 *     elif stat == 'min':
 ...
 */
    __pyx_v_window_function = (&__pyx_f_9geowombat_6moving_7_moving__get_var);
 ...
 */
  ...
  /* "geowombat/moving/_moving.pyx":170
 *     elif stat == 'var':
 *         window_function = &_get_var
 *     elif stat == 'min':             # <<<<<<<<<<<<<<
 *         window_function = &_get_min
 *     elif stat == 'max':
 */
  __pyx_t_8 = (__Pyx_PyString_Equals(__pyx_v_stat, __pyx_n_s_min, Py_EQ)); if (unlikely(__pyx_t_8 < 0)) __PYX_ERR(0, 170, __pyx_L1_error)
  __pyx_t_7 = (__pyx_t_8 != 0);
  if (__pyx_t_7) {

    /* "geowombat/moving/_moving.pyx":171
 *         window_function = &_get_var
 *     elif stat == 'min':
 *         window_function = &_get_min             # <<<<<<<<<<<<<<
 *     elif stat == 'max':
 ...
 */
    __pyx_v_window_function = (&__pyx_f_9geowombat_6moving_7_moving__get_min);
 ...
 */
  ...
  /* "geowombat/moving/_moving.pyx":172
 *     elif stat == 'min':
 *         window_function = &_get_min
 *     elif stat == 'max':             # <<<<<<<<<<<<<<
 *         window_function = &_get_max
 * 
 */
  __pyx_t_7 = (__Pyx_PyString_Equals(__pyx_v_stat, __pyx_n_s_max, Py_EQ)); if (unlikely(__pyx_t_7 < 0)) __PYX_ERR(0, 172, __pyx_L1_error)
  __pyx_t_8 = (__pyx_t_7 != 0);
  if (__pyx_t_8) {

    /* "geowombat/moving/_moving.pyx":173
 *         window_function = &_get_min
 *     elif stat == 'max':
 *         window_function = &_get_max             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_v_window_function = (&__pyx_f_9geowombat_6moving_7_moving__get_max);
 ...
 */
  ...
  /* "geowombat/moving/_moving.pyx":175
 *         window_function = &_get_max
 * 
 *     with nogil, parallel(num_threads=n_jobs):             # <<<<<<<<<<<<<<
 * 
      ...
      /*try:*/ {
        {
            ...
            #endif
            #ifdef _OPENMP
            #pragma omp parallel  private(__pyx_t_10, __pyx_t_11, __pyx_t_12, __pyx_t_13, __pyx_t_14, __pyx_t_15, __pyx_t_16, __pyx_t_17, __pyx_t_18, __pyx_t_19, __pyx_t_20, __pyx_t_9) num_threads(__pyx_v_n_jobs)
            #endif /* _OPENMP */
            {

                /* "geowombat/moving/_moving.pyx":177
 *     with nogil, parallel(num_threads=n_jobs):
 * 
 *         for z in prange(0, dims, schedule='static'):             # <<<<<<<<<<<<<<
 * 
 ...
 */
                ...
                if (1 == 0) abort();
                {
                    ...
                    {
                        #ifdef _OPENMP
                        #pragma omp for lastprivate(__pyx_v_i) lastprivate(__pyx_v_j) firstprivate(__pyx_v_z) lastprivate(__pyx_v_z) schedule(static)
                        #endif /* _OPENMP */
                        for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_11; __pyx_t_10++){
                            {
                                __pyx_v_z = (Py_ssize_t)(0 + 1 * __pyx_t_10);
                                /* Initialize private variables to invalid values */
                                __pyx_v_i = ((Py_ssize_t)0xbad0bad0);
                                __pyx_v_j = ((Py_ssize_t)0xbad0bad0);

                                /* "geowombat/moving/_moving.pyx":179
 *         for z in prange(0, dims, schedule='static'):
 * 
 *             for i in range(0, row_dims):             # <<<<<<<<<<<<<<
 ...
 */
                                __pyx_t_12 = __pyx_v_row_dims;
                                __pyx_t_13 = __pyx_t_12;
                                for (__pyx_t_14 = 0; __pyx_t_14 < __pyx_t_13; __pyx_t_14+=1) {
                                  __pyx_v_i = __pyx_t_14;

                                  /* "geowombat/moving/_moving.pyx":180
 * 
 *             for i in range(0, row_dims):
 *                 for j in range(0, col_dims):             # <<<<<<<<<<<<<<
 *                     output[z, i+hw, j+hw] = window_function(input, z, i, j, dims, window_size, w_samples)
 * 
 */
                                  __pyx_t_15 = __pyx_v_col_dims;
                                  __pyx_t_16 = __pyx_t_15;
                                  for (__pyx_t_17 = 0; __pyx_t_17 < __pyx_t_16; __pyx_t_17+=1) {
                                    __pyx_v_j = __pyx_t_17;

                                    /* "geowombat/moving/_moving.pyx":181
 *             for i in range(0, row_dims):
 *                 for j in range(0, col_dims):
 *                     output[z, i+hw, j+hw] = window_function(input, z, i, j, dims, window_size, w_samples)             # <<<<<<<<<<<<<<
 * 
 ...
 */
                                    ...
                                    __pyx_t_19 = (__pyx_v_i + __pyx_v_hw);
                                    __pyx_t_20 = (__pyx_v_j + __pyx_v_hw);
                                    *((double *) ( /* dim=2 */ ((char *) (((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_output.data + __pyx_t_18 * __pyx_v_output.strides[0]) ) + __pyx_t_19 * __pyx_v_output.strides[1]) )) + __pyx_t_20)) )) = __pyx_v_window_function(__pyx_v_input, __pyx_v_z, __pyx_v_i, __pyx_v_j, __pyx_v_dims, __pyx_v_window_size, __pyx_v_w_samples);
                                  }
                                }
                            }
                        }
 ...
 */
  ...
  /* "geowombat/moving/_moving.pyx":183
 *                     output[z, i+hw, j+hw] = window_function(input, z, i, j, dims, window_size, w_samples)
 * 
 *     return np.float64(output)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_float64); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 183, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __pyx_memoryview_fromslice(__pyx_v_output, 3, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 183, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_2 = NULL;
 ...
 */
  ...
  __Pyx_AddTraceback("geowombat.moving._moving._moving_window3d", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* "geowombat/moving/_moving.pyx":186
 * 
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_9geowombat_6moving_7_moving_1moving_window(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_9geowombat_6moving_7_moving_1moving_window = {"moving_window", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_9geowombat_6moving_7_moving_1moving_window, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_9geowombat_6moving_7_moving_1moving_window(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("moving_window (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_input,&__pyx_n_s_stat,&__pyx_n_s_w,&__pyx_n_s_n_jobs,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        case  1:
        if (kw_args > 0) {
          PyObject* value = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_stat);
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "moving_window") < 0)) __PYX_ERR(0, 186, __pyx_L3_error)
      }
    } else {
  ...
  __Pyx_RaiseArgtupleInvalid("moving_window", 0, 1, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 186, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("geowombat.moving._moving.moving_window", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_input), __pyx_ptype_5numpy_ndarray, 0, "input", 0))) __PYX_ERR(0, 186, __pyx_L1_error)
  __pyx_r = __pyx_pf_9geowombat_6moving_7_moving_moving_window(__pyx_self, __pyx_v_input, __pyx_v_stat, __pyx_v_w, __pyx_v_n_jobs);
...
static PyObject *__pyx_pf_9geowombat_6moving_7_moving_moving_window(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_input, PyObject *__pyx_v_stat, PyObject *__pyx_v_w, PyObject *__pyx_v_n_jobs) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  PyObject *__pyx_t_4 = NULL;
  __Pyx_RefNannySetupContext("moving_window", 0);

  /* "geowombat/moving/_moving.pyx":191
 *                   n_jobs=1):
 * 
 *     return _moving_window3d(input, stat, w, n_jobs)             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyObject_to_MemoryviewSlice_d_d_dc_double(((PyObject *)__pyx_v_input), PyBUF_WRITABLE); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 191, __pyx_L1_error)
  if (!(likely(PyString_CheckExact(__pyx_v_stat))||((__pyx_v_stat) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "str", Py_TYPE(__pyx_v_stat)->tp_name), 0))) __PYX_ERR(0, 191, __pyx_L1_error)
  __pyx_t_2 = __Pyx_PyInt_As_unsigned_int(__pyx_v_w); if (unlikely((__pyx_t_2 == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 191, __pyx_L1_error)
  __pyx_t_3 = __Pyx_PyInt_As_unsigned_int(__pyx_v_n_jobs); if (unlikely((__pyx_t_3 == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 191, __pyx_L1_error)
  __pyx_t_4 = __pyx_f_9geowombat_6moving_7_moving__moving_window3d(__pyx_t_1, ((PyObject*)__pyx_v_stat), __pyx_t_2, __pyx_t_3); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 191, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "geowombat.moving._moving.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "geowombat.moving._moving.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "geowombat.moving._moving.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "geowombat.moving._moving._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec__moving(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec__moving},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_geowombat_moving__moving, __pyx_k_geowombat_moving__moving, sizeof(__pyx_k_geowombat_moving__moving), 0, 0, 1, 1},
  {&__pyx_kp_s_geowombat_moving__moving_pyx, __pyx_k_geowombat_moving__moving_pyx, sizeof(__pyx_k_geowombat_moving__moving_pyx), 0, 0, 1, 0},
 ...
 *                   w=3,
 */
  __pyx_tuple__26 = PyTuple_Pack(4, __pyx_n_s_input, __pyx_n_s_stat, __pyx_n_s_w, __pyx_n_s_n_jobs); if (unlikely(!__pyx_tuple__26)) __PYX_ERR(0, 186, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__26);
  __Pyx_GIVEREF(__pyx_tuple__26);
  __pyx_codeobj__27 = (PyObject*)__Pyx_PyCode_New(4, 0, 4, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__26, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_geowombat_moving__moving_pyx, __pyx_n_s_moving_window, 186, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__27)) __PYX_ERR(0, 186, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC init_moving(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC init_moving(void)
#else
__Pyx_PyMODINIT_FUNC PyInit__moving(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit__moving(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec__moving(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module '_moving' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit__moving(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_moving", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_geowombat__moving___moving) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "geowombat.moving._moving")) {
      if (unlikely(PyDict_SetItemString(modules, "geowombat.moving._moving", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "geowombat/moving/_moving.pyx":9
 * cimport cython
 * 
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 */
  ...
  /* "geowombat/moving/_moving.pyx":16
 * 
 * 
 * DTYPE_float64 = np.float64             # <<<<<<<<<<<<<<
 * ctypedef np.float64_t DTYPE_float64_t
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_DTYPE_float64, __pyx_t_2) < 0) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 *                   w=3,
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_9geowombat_6moving_7_moving_1moving_window, NULL, __pyx_n_s_geowombat_moving__moving); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 186, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_moving_window, __pyx_t_2) < 0) __PYX_ERR(0, 186, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "geowombat/moving/_moving.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init geowombat.moving._moving", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init geowombat.moving._moving");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
